...
<div style="width: 100%;height:100%;">
	<div style="width: 100%">
		<form id="form" action="${ctx}/accout" method="post" onsubmit="return $(this).form('validate')">
			<table width="100%" border="0" class="form-data">
				...
				<tr>
					...
					<td>
						...
						<a href="#" class="easyui-linkbutton" iconCls="icon-cancel" onclick="$.closeWindow('${winId}')">取消</a>
					</td>
				</tr>
			</table>
		</form>
