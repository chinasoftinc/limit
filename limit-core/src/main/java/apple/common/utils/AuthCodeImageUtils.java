...
public class AuthCodeImageUtils {
	...
	/** 图片验证码字库 */
	public static final String CHECKCODE_CHARACTER_LIB = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz1234567890";

	/** 图片验证码随机字体 */
	public static final String[] FONTTYPES = { "\u5b8b\u4f53", "\u65b0\u5b8b\u4f53", "\u9ed1\u4f53", "\u6977\u4f53", "\u96b6\u4e66" };
